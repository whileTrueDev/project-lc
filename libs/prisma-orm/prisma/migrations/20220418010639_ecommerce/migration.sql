...
CREATE TABLE `OrderItemOption` (
    ...
    `amountInExportDone` INTEGER NOT NULL DEFAULT 0,
    `amountInExportReady` INTEGER NOT NULL DEFAULT 0,
    `amountInGoodsReady` INTEGER NOT NULL DEFAULT 0,
    `amountInPaymentCanceled` INTEGER NOT NULL DEFAULT 0,
    `amountInShipping` INTEGER NOT NULL DEFAULT 0,
    `amountInShippingDone` INTEGER NOT NULL DEFAULT 0,
