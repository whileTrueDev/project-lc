export const kkshowShoppingTabDummyData = {
  ...
  popularGoods: [
    {
      name: '식스레시피 감바스 밀키트 캠핑 요리',
      linkUrl: 'https://k-kmarket.com/goods/view?no=160',
      imageUrl:
  ...
  reviews: [
    {
      title: '떡갈비 맛있어요',
      rating: 5,
      linkUrl: 'https://k-kmarket.com/board/view?id=goods_review&seq=10',
      contents:
        '떡갈비 맛있어요!! 구워서 햄버거빵 사이에 넣어 먹었는데 불고기버거 먹는 맛이 났어요 \n밥이랑 먹어도 맛있을거같아요 다음에 또 살게요!!',
      imageUrl:
        'https://k-kmarket.com/data/board/goods_review/873dfd04f466d76f27e88e482633934c1310364.jpg',
      createDate: '2022-03-24',
    },
    {
      title: '양도 많고 맛있어요',
      rating: 5,
      linkUrl: 'https://k-kmarket.com/board/view?id=goods_review&seq=6',
      contents:
        '한번 사먹고 너무 맛있어서 또 샀네요 ㅋㅋ\n\n가격 대비 가성비 좋아요\n\n쭈꾸미 식감도 좋고 밥 볶아 먹으니 꿀맛입니다\n\n많이 맵지는 않은데 맵찔이라면 마요네즈 추가 필수\n\n번창하세요~',
      imageUrl:
    ...
    {
      title: '배송이 잘못왔는데 대처가 너무 만족스럽습니다.',
      rating: '5',
