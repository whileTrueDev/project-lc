...
export const layoutNames: (keyof typeof layoutDesc)[] = [
  LAYOUT_CAROUSEL,
  LAYOUT_AUTO_SLIDE,
  LAYOUT_SMALL_SQUARE_LIST,
  LAYOUT_BIG_SQUARE_LIST,
