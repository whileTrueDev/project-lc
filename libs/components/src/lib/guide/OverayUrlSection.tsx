...
export function OverayUrlSection({
  ...
  return (
    <Stack pt={3} pb={3} spacing={10}>
      <Center>
        <VStack spacing={0}>
          ...
          <Text fontSize="md" fontWeight="semibold">
            아래 URL을 복사하여, 기존 사용하고 있는 송출 프로그램에 추가합니다.
          </Text>
          <Text fontSize="md" fontWeight="semibold">
            이 때 너비는 1920, 높이는 1080으로 세팅하세요.
          </Text>
        </VStack>
      </Center>
      <Center>
      ...
      <Center>
        <VStack spacing={0}>
          <Text fontSize="md">세팅이 완료되면 좌측 최하단에 파란색 점이 나타납니다.</Text>
          <Text fontSize="md">이는 배너 송출이 정상적으로 되고 있다는 신호입니다.</Text>
          <Text fontSize="md">라이브 커머스 종료 시점까지 배너는 끄지 않습니다.</Text>
        </VStack>
      </Center>
      <Center>
        <VStack spacing={0}>
